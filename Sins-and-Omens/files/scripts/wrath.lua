...
local SCRIPT_PATH = "mods/Sins-and-Omens/files/scripts/wrath_damage.lua"
...
local function HasWrathListener(ent)
...
local function AttachWrathListener(ent)
	if HasWrathListener(ent) then return end
...
function M.OnWorldPostUpdate()
	...
	AttachWrathListener(player_entity)
end
