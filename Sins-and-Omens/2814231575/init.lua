...
function OnPlayerSpawned( player_entity ) -- this runs when player entity has been created
	...
	local res_list = {"holy","curse","drill","electricity","explosion","fire","healing","ice","melee","overeating","poison","projectile","radioactive","slice"}
	...
	if damagemodel~= nil then
		for _,damage_type in ipairs(res_list) do
			ComponentObjectSetValue2(  damagemodel,"damage_multipliers", damage_type,0.75 )
		end
	end
	EntityLoad("data/entities/animals/basebot_hidden.xml",px+10,py+10)
	]]--
