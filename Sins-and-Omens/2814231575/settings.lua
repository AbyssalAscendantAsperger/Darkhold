...
local translate = {
	...
	["Enable brief information panel."] = {
		...
		russian = "Панель краткой информации этого мода. Быстрое перекл. \nс помощью кл. быстрого доступа (по умолч. двойной щелчок ПКМ)",
	...
	["Change brief panel hotkey"] = {
		...
		russian = "Смена горячей клавиши, \nсоответствующей переключению панели информации.",
	...
	["Displays as percentage"] = {
		...
		russian = "Отображает значения множителя урона в процентах. \nЕсли выключено, значение множителя урона будет отображаться в десятичном виде.",
