...
If you're the kind of player who reads perk descriptions and thinks *"this seems fine, what could go wrong?"* — these are made for you. And against you.
...
### 🟠 ENVY — *Suffer before the strong — thrive against the weak*
...
Drop the `Sins-and-Omens` folder into your `mods/` directory. Enable it in the mod menu. Start a new run. Find a perk altar. Pray.

Or don't pray. The sins don't care. They'll find you either way.
